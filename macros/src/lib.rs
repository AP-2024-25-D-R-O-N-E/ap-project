    ...
    let fields = match input.data {
        ...
        Data::Enum(ref data_enum) => {
            ...
            let match_arms = variants.iter().map(|variant| {
                ...
                let ref_fields = match &variant.fields {
                    Fields::Named(fields) => {
                    ...
                    Fields::Unnamed(fields) => {
                        ...
                        let unnamed_fields = fields.unnamed.iter().enumerate().map(|(index, field)| {
                ...
                let rv =    quote! { #enum_name_ref_ident :: #variant_ref_ident #ref_fields =>  #enum_name_ident :: #variant_ident #ref_fields_into_serializable };
